...
public class LinkedListDequeTest {
    ...
    * 2. returns null if no such item exists. */
    public void iteratedGetTest() {
        LinkedListDeque<Integer> lld1 = new LinkedListDeque<Integer>();
        lld1.addLast(1);
        lld1.addLast(2);
        lld1.addLast(3);
        int actual1 = lld1.get(0);
        Object actual2 = lld1.get(3);
    ...
    public void recursiveGetTest() {
        ...
        lld1.addLast(2);
        lld1.addLast(3);
        int actual1 = lld1.getRecursive(0);
        Object actual2 = lld1.getRecursive(3);
        assertEquals("Should have the same value", 1, actual1);
        assertEquals("Should return null", null, actual2);
    }
    ...
    public void equalsTest() {
        ...
        lld2.addLast(2);
        lld2.addLast(3);
        assertTrue("This should return true", lld1.equals(lld2));
    }
}
